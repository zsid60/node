...
* [[`9a6aff8517`](https://github.com/nodejs/node/commit/9a6aff8517)] - **(SEMVER-MINOR)** **doc**: make `AssertionError` a link (Ruben Bridgewater) [#28263](https://github.com/nodejs/node/pull/28263)
* [[`08b5a2fcb4`](https://github.com/nodejs/node/commit/08b5a2fcb4)] - **(SEMVER-MINOR)** **doc**: update assert.throws() examples (Ruben Bridgewater) [#28263](https://github.com/nodejs/node/pull/28263)
* [[`7d6c963b9d`](https://github.com/nodejs/node/commit/7d6c963b9d)] - **(SEMVER-MINOR)** **assert**: DRY .throws code (Ruben Bridgewater) [#28263](https://github.com/nodejs/node/pull/28263)
* [[`749bc16cca`](https://github.com/nodejs/node/commit/749bc16cca)] - **(SEMVER-MINOR)** **assert**: fix generatedMessage property (Ruben Bridgewater) [#28263](https://github.com/nodejs/node/pull/28263)
...
* [[`0376e1cf4d`](https://github.com/nodejs/node/commit/0376e1cf4d)] - **(SEMVER-MINOR)** **util**: fix built-in detection (Ruben Bridgewater) [#30768](https://github.com/nodejs/node/pull/30768)
...
* [[`d7d7cf7513`](https://github.com/nodejs/node/commit/d7d7cf7513)] - **(SEMVER-MINOR)** **http2**: implement capture rection for 'request' and 'stream' events (Matteo Collina) [#27867](https://github.com/nodejs/node/pull/27867)
* [[`ba18406402`](https://github.com/nodejs/node/commit/ba18406402)] - **(SEMVER-MINOR)** **tls**: implement capture rejections for 'secureConnection' event (Matteo Collina) [#27867](https://github.com/nodejs/node/pull/27867)
* [[`75972da470`](https://github.com/nodejs/node/commit/75972da470)] - **(SEMVER-MINOR)** **net**: implement capture rejections for 'connection' event (Matteo Collina) [#27867](https://github.com/nodejs/node/pull/27867)
* [[`35a33f6e01`](https://github.com/nodejs/node/commit/35a33f6e01)] - **(SEMVER-MINOR)** **http**: add captureRejection support to OutgoingMessage (Matteo Collina) [#27867](https://github.com/nodejs/node/pull/27867)
* [[`f7d128ad48`](https://github.com/nodejs/node/commit/f7d128ad48)] - **(SEMVER-MINOR)** **http**: implement capture rejections for 'request' event (Matteo Collina) [#27867](https://github.com/nodejs/node/pull/27867)
* [[`d627724e9d`](https://github.com/nodejs/node/commit/d627724e9d)] - **(SEMVER-MINOR)** **stream**: add support for captureRejection option (Matteo Collina) [#27867](https://github.com/nodejs/node/pull/27867)
...
* [[`8dc4e4ecb7`](https://github.com/nodejs/node/commit/8dc4e4ecb7)] - **(SEMVER-MINOR)** **cli**: add --trace-exit cli option (legendecas) [#30516](https://github.com/nodejs/node/pull/30516)
...
* [[`850cb15ae8`](https://github.com/nodejs/node/commit/850cb15ae8)] - **(SEMVER-MINOR)** **deps**: upgrade to libuv 1.34.0 (Colin Ihrig) [#30783](https://github.com/nodejs/node/pull/30783)
...
* [[`860139408d`](https://github.com/nodejs/node/commit/860139408d)] - **(SEMVER-MINOR)** **test**: update and harden http2-reset-flood (Denys Otrishko) [#30534](https://github.com/nodejs/node/pull/30534)
...
* [[`7998fbb7e9`](https://github.com/nodejs/node/commit/7998fbb7e9)] - **(SEMVER-MINOR)** **http2**: replace direct array usage with struct for js\_fields\_ (Denys Otrishko) [#30534](https://github.com/nodejs/node/pull/30534)
...
* [[`df54ec3eb2`](https://github.com/nodejs/node/commit/df54ec3eb2)] - **(SEMVER-MINOR)** **crypto**: add support for IEEE-P1363 DSA signatures (Tobias Nießen) [#29292](https://github.com/nodejs/node/pull/29292)
...
* [[`df1e183e3f`](https://github.com/nodejs/node/commit/df1e183e3f)] - **(SEMVER-MINOR)** **child_process,cluster**: allow using V8 serialization API (Anna Henningsen) [#30162](https://github.com/nodejs/node/pull/30162)
...
* [[`ba289ffb4e`](https://github.com/nodejs/node/commit/ba289ffb4e)] - **(SEMVER-MINOR)** **cli**: whitelist new V8 flag in NODE\_OPTIONS (Shelley Vohr) [#30094](https://github.com/nodejs/node/pull/30094)
...
* [[`bcd27f7300`](https://github.com/nodejs/node/commit/bcd27f7300)] - **(SEMVER-MINOR)** **lib**: no need to strip BOM or shebang for scripts (Refael Ackermann) [#27375](https://github.com/nodejs/node/pull/27375)
* [[`1c50714729`](https://github.com/nodejs/node/commit/1c50714729)] - **(SEMVER-MINOR)** **lib**: rework logic of stripping BOM+Shebang from commonjs (Gus Caplan) [#27768](https://github.com/nodejs/node/pull/27768)
...
* [[`dc58731e28`](https://github.com/nodejs/node/commit/dc58731e28)] - **(SEMVER-MINOR)** **cli**: add --trace-uncaught flag (Anna Henningsen) [#30025](https://github.com/nodejs/node/pull/30025)
...
* [[`5dd72a67c4`](https://github.com/nodejs/node/commit/5dd72a67c4)] - **(SEMVER-MINOR)** **crypto**: add Hash.prototype.copy() method (Ben Noordhuis) [#29910](https://github.com/nodejs/node/pull/29910)
...
* [[`8d336ff796`](https://github.com/nodejs/node/commit/8d336ff796)] - **(SEMVER-MINOR)** **deps,src**: patch V8 to be API/ABI compatible with 7.4 (from 7.8) (Anna Henningsen) [#30109](https://github.com/nodejs/node/pull/30109)
* [[`b335529803`](https://github.com/nodejs/node/commit/b335529803)] - **(SEMVER-MINOR)** **deps**: patch V8 to be API/ABI compatible with 7.4 (from 7.7) (Michaël Zasso) [#29241](https://github.com/nodejs/node/pull/29241)
...
* [[`bb616bb06b`](https://github.com/nodejs/node/commit/bb616bb06b)] - **(SEMVER-MINOR)** **deps**: patch V8 to be API/ABI compatible with 7.4 (from 7.5) (Michaël Zasso) [#28005](https://github.com/nodejs/node/pull/28005)
* [[`18c713da2c`](https://github.com/nodejs/node/commit/18c713da2c)] - **(SEMVER-MINOR)** **deps**: update V8's postmortem script (Colin Ihrig) [#29694](https://github.com/nodejs/node/pull/29694)
...
* [[`5e1da86d9b`](https://github.com/nodejs/node/commit/5e1da86d9b)] - **(SEMVER-MINOR)** **deps**: V8: cherry-pick 0a055086c377 (Michaël Zasso) [#30109](https://github.com/nodejs/node/pull/30109)
...
* [[`4cdccbda80`](https://github.com/nodejs/node/commit/4cdccbda80)] - **(SEMVER-MINOR)** **deps**: V8: cherry-pick 716875d (Myles Borins) [#29694](https://github.com/nodejs/node/pull/29694)
...
* [[`a19e9bd933`](https://github.com/nodejs/node/commit/a19e9bd933)] - **(SEMVER-MINOR)** **tools**: patch V8 to run on older XCode versions (Ujjwal Sharma) [#29694](https://github.com/nodejs/node/pull/29694)
* [[`b4e8f0de12`](https://github.com/nodejs/node/commit/b4e8f0de12)] - **(SEMVER-MINOR)** **assert**: fix line number calculation after V8 upgrade (Michaël Zasso) [#29694](https://github.com/nodejs/node/pull/29694)
* [[`0df49106d5`](https://github.com/nodejs/node/commit/0df49106d5)] - **(SEMVER-MINOR)** **tools**: update V8 gypfiles (Michaël Zasso) [#29694](https://github.com/nodejs/node/pull/29694)
* [[`d89f874871`](https://github.com/nodejs/node/commit/d89f874871)] - **(SEMVER-MINOR)** **deps**: V8: fix linking issue for MSVS (Refael Ackermann) [#28016](https://github.com/nodejs/node/pull/28016)
* [[`0d20a85b8e`](https://github.com/nodejs/node/commit/0d20a85b8e)] - **(SEMVER-MINOR)** **deps**: V8: fix BUILDING\_V8\_SHARED issues (Refael Ackermann) [#27375](https://github.com/nodejs/node/pull/27375)
* [[`3d11924917`](https://github.com/nodejs/node/commit/3d11924917)] - **(SEMVER-MINOR)** **deps**: V8: add workaround for MSVC optimizer bug (Refael Ackermann) [#28016](https://github.com/nodejs/node/pull/28016)
* [[`9135bc219b`](https://github.com/nodejs/node/commit/9135bc219b)] - **(SEMVER-MINOR)** **deps**: V8: use ATOMIC\_VAR\_INIT instead of std::atomic\_init (Refael Ackermann) [#27375](https://github.com/nodejs/node/pull/27375)
* [[`d98789b348`](https://github.com/nodejs/node/commit/d98789b348)] - **(SEMVER-MINOR)** **deps**: V8: forward declaration of `Rtl\*FunctionTable` (Refael Ackermann) [#27375](https://github.com/nodejs/node/pull/27375)
* [[`5a31dc8177`](https://github.com/nodejs/node/commit/5a31dc8177)] - **(SEMVER-MINOR)** **deps**: V8: patch register-arm64.h (Refael Ackermann) [#27375](https://github.com/nodejs/node/pull/27375)
* [[`fe18796b03`](https://github.com/nodejs/node/commit/fe18796b03)] - **(SEMVER-MINOR)** **deps**: V8: silence irrelevant warning (Michaël Zasso) [#26685](https://github.com/nodejs/node/pull/26685)
* [[`4bf6e025a7`](https://github.com/nodejs/node/commit/4bf6e025a7)] - **(SEMVER-MINOR)** **deps**: V8: un-cherry-pick bd019bd (Refael Ackermann) [#26685](https://github.com/nodejs/node/pull/26685)
* [[`fdad5b6f38`](https://github.com/nodejs/node/commit/fdad5b6f38)] - **(SEMVER-MINOR)** **deps**: V8: fix filename manipulation for Windows (Refael Ackermann) [#28016](https://github.com/nodejs/node/pull/28016)
* [[`a91ed2eada`](https://github.com/nodejs/node/commit/a91ed2eada)] - **(SEMVER-MINOR)** **build**: reset embedder string to "-node.0" (Michaël Zasso) [#30109](https://github.com/nodejs/node/pull/30109)
...
* [[`922042a017`](https://github.com/nodejs/node/commit/922042a017)] - Working on v12.15.1 (Beth Griggs) [nodejs-private/node-private#197](https://github.com/nodejs-private/node-private/pull/197)
* [[`31d3b6d9cb`](https://github.com/nodejs/node/commit/31d3b6d9cb)] - 2020-02-06, Version 12.15.0 'Erbium' (LTS) (Beth Griggs) [nodejs-private/node-private#197](https://github.com/nodejs-private/node-private/pull/197)
